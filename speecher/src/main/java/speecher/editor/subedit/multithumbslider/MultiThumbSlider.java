 ...
 *
 * @param <T> the type of data each float maps to. For example: in the
...
public class MultiThumbSlider<T> extends JComponent {
     ...
     * @param values         an array of values, each value corresponds to a value in
     ...
     * @throws IllegalArgumentException if the size of the arrays are different, or if the
     ...
     *
     * @param ignoreIfUnfocused if this component doesn't have focus and this is
