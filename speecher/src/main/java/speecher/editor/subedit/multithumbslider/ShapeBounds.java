...
public class ShapeBounds {
     ...
     *
     * @param shape the shape you want the bounds of. This method throws a
     ...
     * @param transform if this is non-null, then this method returns the bounds of
     *                  <code>shape</code> as seen through <code>t</code>.
     * @param r         if this is non-null, then the result is stored in this
     ...
     * This calculates the precise bounds of a shape.
     *
     * @param i the shape you want the bounds of. This method throws a
     *          NullPointerException if this is null.
