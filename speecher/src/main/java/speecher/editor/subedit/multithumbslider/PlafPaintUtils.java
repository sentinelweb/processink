...
public class PlafPaintUtils {
     ...
     * @param changeRenderingHints if true then the rendering hints will be modified, if false
     ...
     *
     * @param stripeWidth the stripe width. The exact size of the resulting image will
     *                    be approximately (sqrt(8)*stripeWidth)
     * @param color1      the color of one stripe
     * @param color2      the color of the other stripe
     * @return
     */
