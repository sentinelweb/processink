...
public abstract class MultiThumbSliderUI<T> extends ComponentUI implements
    ...
    public static enum Thumb {
         ...
         * @param width     the width of the the thumb (assuming this is a horizontal
         *                  slider)
         * @param height    the height of the the thumb (assuming this is a horizontal
         *                  slider)
         ...
         * @param leftEdge       true if this is the left-most thumb
         * @param rightEdge      true if this is the right-most thumb.
         * @param sharpEdgesHint if true then this may return something more polygonal with
